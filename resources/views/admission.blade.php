    ...
    <body>
       ...
       <!-- About st -->
        ...
        <div class="row page-title page-title-about">
            <div class="container">
                <h2><i class="fa fa-graduation-cap"></i>ACHIEVEMENT</h2>
            </div>
        </div>
            ...
            <div class="container">
                <div class="fact-wrapper">
                    <div class="col-md-5 fact-item">
                        ...
                        <p>METRO SCHOOL won best School award in 2016</p>
        ...
        <div class="row section-row">
            <div class="container">
                <div class="section-row-header-center">
                    ...
                    <h1>WHY METRO SCHOOL?</h1>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
                </div>
                <div class="col-md-6">
                    <div id="pathshalaAccordion" class="pathshala-accordion faq-accordion">
                        <h4 class="accordion-header">Why you should choose METRO SCHOOL?</h4>
                        ...
                        <h4 class="accordion-header">What METRO SCHOOL Offers?</h4>
                        <div class="accordion-inner">
                            <p>Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer
                                    ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit
                                    amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi.
        ...
        <div class="row footer-row">
            <div class="container">
                ...
                <div class="col-md-4 col-sm-6 footer-item">
                    ...
                    <p><i class="fa fa-envelope"></i>email@METRO SCHOOL.com</p>
                </div>
