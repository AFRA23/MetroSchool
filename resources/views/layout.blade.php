          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown mail-notification" aria-labelledby="MailDropdown">
              <a class="dropdown-item" href="{{URL::to('/logout')}}">
                ...
                <div class="sender">
                  <p href="#" class="Sende-name">Logout</p>
                </div>
              </a>
            </div>
          </li>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">Afra Ibnat Khan</p>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/play')}}">Play</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/nursery')}}">Nursery</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/one')}}">One</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/two')}}">Two</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/three')}}">Three</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/four')}}">Four</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/five')}}">Five</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/six')}}">Six</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/seven')}}">Seven</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/eight')}}">Eight</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/nine')}}">Nine</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/ten')}}">Ten</a>
                  </li>
