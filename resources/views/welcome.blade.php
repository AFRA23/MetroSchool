    ...
    <body>
        <div class="row nav-row trans-menu">
            <div class="container nav-container">
                ...
                <div class = "clearfix"></div>
                <nav id="METROSCHOOLNavbar" class="navbar navbar-default" role="navigation">
                    <!-- Brand and toggle get grouped for better mobile display -->
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#METROSCHOOLNavbarCollapse">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        ...
                        <div class="carousel-caption">
                            ...
                            <p>We here at <strong>METRO SCHOOL</strong> provides best education <br /> to your little one</p>
        ...
        <div class="row principal-intro-row">
            <div class="container">
                ...
                <div class="col-sm-7 principal-intro">
                    ...
                    <h6 class="principal-name">MOHAMMAD JAKIR, Graphic Designer</h6>
                    <div>
                ...
                <div class="owl-carousel" id="ourTeacher">
                    ...
                    <div class="teacher-item">
                        ...
                        <div class="teacher-item-inner">
                            ...
                            <div class="col-xs-8 teacher-details">
                                <p><strong>SOUROV MOHIUDDIN</strong></p>
        ...
        <div class="row footer-row">
            <div class="container">
                ...
                <div class="col-md-4 col-sm-6 footer-item">
                    ...
                    <p><i class="fa fa-mobile"></i> +88 0170000891</p>
...
<script>'undefined'=== typeof _trfq || (window._trfq = []);'undefined'=== typeof _trfd && (window._trfd=[]),_trfd.push({'tccl.baseHost':'secureserver.net'}),_trfd.push({'ap':'cpsh'},{'server':'a2plcpnl0381'})    </script><script src='../../../../../img1.wsimg.com/tcc/tcc_l.combined.1.0.6.min.js'></script>
  ...
  <p style="text-align:center">©2020 Afra Ibnat Khan. All Rights Reserved<p>
</html>