            ...
            <div class="card-body px-5 py-5">
              ...
              <form method="POST" action="{{ url('/adminlogin') }}">
                ...
                <div class="form-group">
                  <label>Email </label>
                  <input type="email" class="form-control p_input" name="admin_email" placeholder="Enter your email">
                </div>
                <div class="form-group">
                  <label>Password</label>
                  <input type="password" class="form-control p_input" name="admin_password" placeholder="Enter your password">
                </div>
