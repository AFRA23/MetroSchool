...
<head>
  ...
  <title>METRO SCHOOL | Teacher Dashboard</title>
  <!-- plugins:css -->
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('/teacher_dashboard')}}"><img src="" alt="Logo"></a>
      </div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">{{strtoupper($view_teacher_desc->teachers_name)}}</p>
              <p class="designation">{{$view_teacher_desc->teachers_phone}}</p>
            </div>
          </div>
          <ul class="nav">
            <!--main pages start-->
